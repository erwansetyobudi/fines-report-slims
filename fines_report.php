...
/* Fines Report by Erwan Setyo Budi*/
...
<?php
    ...
    while ($_fines_d = $_fines_q->fetch_row()) {
        ...
        $total_denda += $_fines_d[1]; // Tambahkan denda ke total
    }
    ...
    echo '<div class="mt-3"><strong>'.__('Total Fines: ').currency($total_denda).'</strong></div>';
